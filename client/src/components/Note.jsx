    ...
    renderForm() {
        return (
            <div className="notes-box" defaultValue={this.props}>
                ...
                <br/>
                <button onClick= {() =>this.props.updateNote(this.update())}>
                    Update</button>
            </div>
            ...
            <Draggable >
                <div className="notes-box">
                    ...
                    <button
                        ...
                        onClick={() => this.props.deleteNote({title: this.props.info.title, content: this.props.info.content, id: this.props.info.id})}>&times;</button>
